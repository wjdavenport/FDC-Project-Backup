...
def main():
    ...
    def boolean_text_features(df):
        ...
        return pd.DataFrame({
            ...
            "mentions_anesthesia":    txt.str.contains(r"\banesth(?:e|a)si", regex=True),
            ...
            # positive/on-topic
            "mentions_processing":    txt.str.contains(r"bprocess\b"),
            "mentions_unaware":       txt.str.contains(r"bunaware\b"),
            "mentions_IIT":           txt.str.contains(r"bintegrated*information*theory\b"),
            "mentions_GWT":           txt.str.contains(r"bglobal*workspace*theory\b"),
            

            # negative/off-topic
            "mentions_sedation":      txt.str.contains(r"bsedati\w*\b"),
            animals = r"\b(?:rats?|dogs?|cats?|sheep|mice)\b"
            "mentions_c_animals":     txt.str.contains(animals, case=False),
            pattern_aLOC = r"\b(?altered|decreased|reduced|impaired)\W*(?:levels*of\W*consciousness\b"
            "mentions_aLOC":          txt.str.contains(pattern_aLOC)
            "mentions_alcohol":       txt.str.contains(r"\balcohol\b"),
